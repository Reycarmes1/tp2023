...
function sendEmail($to, $body, $altBody, $asunto, $emailRespuesta, $persona)
{
  ...
  try {
    ...
    $mail->Username   = 'miguelcabrera3520@gmail.com';                     //SMTP username
    $mail->Password   = 'Pepe2022';                             //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
    //Recipients
    $mail->setFrom('miguelcabrera3520@gmail.com', 'UTN FRRo');
    if (empty($to)) {
      $mail->addAddress('miguelcabrera3520@gmail.com');     //Add a recipient
      $mail->addCC($emailRespuesta);
    } else {
      $mail->addAddress('miguelcabrera3520@gmail.com');     //Add a recipient
      $mail->addCC('miguelcabrera3520@gmail.com');
    }
