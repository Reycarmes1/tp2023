            ...
            <div class="row mt-3">
               ...
               <!-- <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <ul>
                    ...
                    <p>
                    <img src=<?= "$URL/views/static/img/logo-utn-footer.png" ?> class="img-fluid" alt="Logo UTN" width="100" height="100" >
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-home me-3"></i>Rosario - Zeballos 1341&nbsp; &nbsp;
                        ...
                        <b>  &nbsp;Copyright © 2023. Todos los derechos reservados </b> 
                    </p>
                </ul>
...
<script src="./views/static/js/validate.js"></script>
</body>
