            ...
            <div class="col d-flex justify-content-end pt-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href=<?= "$URL/listado_consultas"; ?>>Listado de Clases</a></li>
                        <li class="breadcrumb-item active text-dark" aria-current="page">Nueva Clase</li>
                    </ol>
                </nav>
            </div>
        </div>
