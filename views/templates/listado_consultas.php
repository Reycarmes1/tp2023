...
if (isset($_SESSION["rol"]) and $_SESSION["rol"] == "Profesor") {
  header("Location: mis_consultas/1");
  exit();
}
      ...
      <div class="col d-flex justify-content-end pt-4">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active text-dark" aria-current="page">Listado de Clases</li>
          </ol>
        </nav>
      </div>
    </div>
      ...
      <div class="modal-body">
        <form action=<?= "$URL/listado_consultas/1" ?> method="POST">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="asunto" name="asunto" maxlength="250" placeholder="Ingresar motivo por el cual querés ir a clase (por ej.: Quiero Definir Mi...)"></textarea>
          </div>
